export default function WhyUs() {
  return (
    <section id="why-us" className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-emerald-50 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 animate-slide-in-right">
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              <div className="text-4xl font-bold text-emerald-500 mb-2 group-hover:scale-110 transition-transform duration-300">98%</div>
            ...
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group" style={{ animationDelay: '0.1s' }}>
              <div className="text-4xl font-bold text-emerald-500 mb-2 group-hover:scale-110 transition-transform duration-300">24hr</div>
            ...
            <div className="text-center bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group" style={{ animationDelay: '0.2s' }}>
              <div className="text-4xl font-bold text-emerald-500 mb-2 group-hover:scale-110 transition-transform duration-300">250+</div>
